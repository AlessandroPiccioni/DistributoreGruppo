...
public class Main {
	...
	static void stampaMenu() {
		...
		System.out.println("6) Il totale incasso di un Distributore.");
	        ...
	        do {
	        	//Menu operatore
					...
					case 4:
						...
						break;
					case 5:
						//Case che contiene la gestione dello Distributore
				...
				System.out.println();
					...
					int i=dis.vuoti();
					//Controllo per vedere se il Distributore sia vuoto
					if(i==(dis.getProdotto().length*dis.getProdotto()[0].length)) {
						...
						do {
							...
							if(!id.isEmpty()) {
								...
								int indiceProdotto []= dis.ricerca(id);
	...
	//Gestione moneta 
	static double gestioneMoneta (int [] indiceProdotto, Scanner scanner, Distributore dis, double portafoglio) {
		double somma=0;
		double moneta=0;
	...
	static String controlloID(Distributore dis, Scanner scanner) {
    ...
    static Distributore aggiungere(Distributore dis, Scanner scanner) {
    	int Categoria=0;
    	String id=" ";
    	String nome=" ";
    	double prezzo= 0;
    ...
    //Eliminare un specifico prodotta dal Distributore
    static Distributore rimuovere(Distributore dis, Scanner scanner) {
    	
    	int spazioDisponibile=0; //Variabile per il totale
    	int prodRimuovere =0;
    	int spazioVuoti =dis.vuoti();
    	String id=" ";
    	...
    	if(spazioVuoti==(dis.getProdotto()[0].length*dis.getProdotto().length)) {
    		System.out.println("Il Distributore è vuoto. Non puoi rimuovere nessun prodotto.");
    ...
    //Cambiare quantita
    static Distributore cambiareQuat(Distributore dis, Scanner scanner) {
    ...
    //Cambiare quantita
    static Distributore cambiarePrezzo(Distributore dis, Scanner scanner) {
